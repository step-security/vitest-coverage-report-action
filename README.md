...
| `threshold-icons`           | A JSON object mapping coverage percentage thresholds to status icons. This setting will take precedence over configured thresholds. See [Threshold Icons](#threshold-icons) for details.                                                          | ''                                                                                                                                                                                                                                                                 |
